...
from network_builder.api.v1alpha1.pysrc.portlibrarystate import PORTLIBRARYSTATE_SCHEMA
from network_builder.intents.portlibrary.handlers import get_config_handler
from network_builder.intents.portlibrary.init import init_globals_defaults, validate
...
def process_cr(cr):
    ...
    eda.update_cr(
        schema=PORTLIBRARYSTATE_SCHEMA,
        name=cr_name,
        spec={
