...
from sandy.api.v1alpha1.pysrc.sitetosite import SiteToSite
from sandy.api.v1alpha1.pysrc.sitetositestate import SITETOSITESTATE_SCHEMA
from sandy.intents.sitetosite.handlers import get_config_handler
from sandy.intents.sitetosite.init import init_globals_defaults, validate

def process_cr(cr):
    """Process SiteToSite CR."""
    log_msg("SiteToSite CR:", dict=cr)
    cr_obj = SiteToSite.from_input(cr)
    if cr_obj is None:
        return
