...
// SiteToSiteSpec defines the desired state of SiteToSite
...
// SiteToSiteStatus defines the observed state of SiteToSite
type SiteToSiteStatus struct {
	// +eda:ui:title="Nodes"
